...
#  summary regression tables ==> estimation table
...
tabs2latex4 <- function(est, digits = 3, roworder = NULL, 
  ...
  SatterthwaiteDigits = digits,
  startingnumber = 1, ...)
#  Produces estimated results table of columns
#      "epc"              "esc"            "ep"            "satt"
#       est                est              est             est
#    (p value)   or       (se)      or   (p value)  or   (p value)
#    [lb, ub]            [lb, ub]                            [dof]
