...
# path0 <- "c:/data/Ramadan/"; setwd(path <- paste0(path0, "submit2024/docs/")); pathprogram <- paste0(path, "program/"); rmarkdown::render(paste0(pathprogram, "RamadanEstimation_Tufte.Rmd"))
...
getwd()
here::i_am("Submit2024/docs/program/RamadanEstimation_Tufte.Rmd")
getwd()
