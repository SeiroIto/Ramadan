...
\hfil\input{Tables/Main1999Older10ByGenderByAgHHdefResults.tex}
...
\begin{eqnarray}
    ...
    &+&\SAdded{a_{6}\textnormal{Overlapping-State}_{ih}+a_{7}\textnormal{Overlapping-State}_{ih}\times\textnormal{Agri}_{ih}}   \nonumber \\
...
\SAdded{We need to include $a_{6}\textnormal{Overlapping-State}_{ih}+a_{7}\textnormal{Overlapping-State}_{ih}\times\textnormal{Agri}_{ih}$ on the RHS. Otherwise, estimates are biased.}
}
