...
ltb <- c(
    ltb[1],
    "\\\\makebox[2cm]{Group} & \\\\makebox[2.5cm]{Quartile} & \\\\multicolumn{c}{9}{Reasons} & \\\\makebox[1cm]{Total}\\\\\\\\", 
    ltb[2], 
    "\\\\hline",
    ltb[-c(1:2)]
  )
...
kt <- column_spec(kt, 2, width = "3.75cm; min-width:3.75cm;")
kt <- column_spec(kt, 3:10, width = "2.25cm; min-width:2.25cm;")
ktReaPC4 <- footnote(kt, 
           general = "Sample of direct offspring of household heads. Observations are children who are not attending school in each year. Dropouts are children who was attending school in 1999 and have disconitnued by 2002. Nonattendees are all children who are not attending school in respective years."
           )
...
ltb <- c(
    ltb[1],
    "\\\\makebox[2cm]{Group} & \\\\makebox[2.5cm]{HH type} & \\\\multicolumn{c}{9}{Reasons} & \\\\makebox[1cm]{Total}\\\\\\\\", 
    ltb[2], 
    "\\\\hline",
    ltb[-c(1:2)]
  )
