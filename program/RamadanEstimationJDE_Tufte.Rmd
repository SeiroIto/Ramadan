...
ltb <- latextab(Tab, delimiterline = NULL, 
    hcenter = c(3.25, rep(1.3, ncol(Tab)-1)),
...
ltb4 <- ltb[
    c(1:(aghhrows[1]+2), r2rows[1]+c(0, 2, 3:6),
       aghhrows[2]+(-2:2), r2rows[1]+c(0, 2, 3:6), length(ltb)-2:0)
    ]
write.tablev(ltb4
  ,  paste0("../save/", c("Main", "Placebo")[ii], "Older", (10:12)[s], 
...
ltb4 <- ltb[
    c(
      ...
      aghhrows[2]+(-3:2), r2rows[2]+c(0, 2, 3, 5), length(ltb)-2:0
      )
    ]
write.tablev(ltb4
  ,  paste0("../save/", c("Main", "Placebo")[ii], "Older", (10:12)[s], 
       "ByResultsConcise.tex")
  ,  colnamestrue = F)
#### HTML output
library(kableExtra)
...
ltb1 <- c(ltb[1:(aghhrows[2]-1)], ltb[length(ltb)-2:0])
...
ltb4 <- ltb[
    c(1:(aghhrows[1]+8), r2rows[1]+c(0, 2, 3:6),
       aghhrows[2]+(-2:8), r2rows[1]+c(0, 2, 3:6), length(ltb)-2:0)
    ]
write.tablev(ltb4
  ,  paste0("../save/", c("Main", "Placebo")[ii], "Older", (10:12)[s], 
...
write.tablev(ltb
  ,  paste0("../save/", c("Main", "Placebo")[ii], "Older", (10:12)[s], 
       "NumGradeDaysAbsentResultsConcise.tex")
  ,  colnamestrue = F)
#### HTML output
library(kableExtra)
#### Tab <- TabGD
Tab <- MNDbg
iii <- grep("^Stipend|^Non", Tab[, 1])
Tab <- Tab[-(rep(iii, each = 3)+0:2), ]
