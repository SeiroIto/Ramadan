...
kt <- kable(SDiff.print[, -(1:2)], 
  caption = "Differences between agricultural and non-agricultural households in main data")
kt <- column_spec(kt, 1, width = "7cm; min-width:7cm;")
