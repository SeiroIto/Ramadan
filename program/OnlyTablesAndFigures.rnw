...
<<results = "hide", echo = F>>=
source("TabGeneric.R")
TabFNLine1 <- "\\\\[-1ex] Notes:& 1. A first-difference estimator with standard errors clustered at \\textit{thana} level. Standard errors are clusterd at thana level with Satterthwaite degrees of freedom adjusted for a small number of clusters. $P$ values are shown in the parentheses. 95\\% confidence intervals are shown in square brackets. "
@
...
DisplayEstTable(
  ...
  TABFilePath1 = TabFilePathF(
    FolderPath = "../save/", AgeCutoff = "Older10", Sample = "Main", 
    CRSEMethod = "ByGenderByAgeGroup2Results")
  ,
...
DisplayEstTable(
  ...
  TABFilePath1 = TabFilePathF(
    FolderPath = "../save/", AgeCutoff = "Older10", Sample = "Main", 
    CRSEMethod = "MuslimFloodResults1")
  ,
  TABFilePath2 = TabFilePathF(
    FolderPath = "../save/", AgeCutoff = "Older10", Sample = "Main", 
    CRSEMethod = "MuslimFloodResults2")
  ,
  TABTitle="Alternative mechanisms, flood and non-Muslims")
}
