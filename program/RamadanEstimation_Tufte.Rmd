...
kt <- row_spec(kt, rep(aghhrows, each = 3)+0:2, 
  color = "black", background = "#87cefa")
kt <- pack_rows(kt, group_label="Grade progression: Enrolled in 1999", 
  aghhrows[1]-1, aghhrows[2]-1)
kt <- pack_rows(kt, group_label="Grade progression: Enrolled in 1999 and 2002", 
  aghhrows[2]-1, aghhrows[3]-1)
kt <- pack_rows(kt, group_label="Days absent: Enrolled in 1999 and 2002", 
  aghhrows[3]-1, aghhrows[4]-1)
kt <- pack_rows(kt, group_label="Days absent: Enrolled in 1999 and 2002, cross section OLS of 1999", 
  aghhrows[4]-1, aghhrows[5]-1)
kt <- pack_rows(kt, group_label="Grade progression: Placebo estimation of 2002 cohort", 
  aghhrows[5]-1, aghhrows[6]-1)
kt <- pack_rows(kt, group_label="Grade progression: Placebo estimation of 1999 cohort", 
