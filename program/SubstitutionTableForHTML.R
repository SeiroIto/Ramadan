sbt <- c(
  ...
  "^StipendProgram$", "Stipend program",
  "^NonStipendProgram$", "Non-stipend program",
  "^yield", "yield (thana)",
  "^yr3", "year 2006",
  "^yr2$", "year 2002",
  "^yr1", "year 1999",
  "^agHH$", "Agricultural household",
  "^hdagHH$", "Agricultural household (head definition)",
  "^agHHold", "\\hspace{.5em}Agricultural household $\\times$  age $>$ 10",
...
#  "^DummyAge.18.yr3", "\\hspace{.5em}age 18$+$ in 1999",
  ...
  "dummyAailjhar.yr2$", "\\hspace{.5em}Aailhhar district $\\times$ year 2002",
  "dummyChokoria.yr2$", "\\hspace{.5em}Chokoria district $\\times$ year 2002",
  "dummyHaziganj.yr2$", "\\hspace{.5em}Haziganj district $\\times$ year 2002",
  "dummyAailjhar.yr3$", "\\hspace{.5em}Aailhhar district $\\times$ year 2006",
  "dummyChokoria.yr3$", "\\hspace{.5em}Chokoria district $\\times$ year 2006",
  "dummyHaziganj.yr3$", "\\hspace{.5em}Haziganj district $\\times$ year 2006",
  "^pov", "poverty (=1 if BPL)",
  "^hd.age", "\\hspace{.5em}head age",
  "^hd.edu.*pr", "\\hspace{.5em}head primary",
  "^hd.edu.*sec", "\\hspace{.5em}head secondary",
  "^sp.age", "\\hspace{.5em}spouse age",
  "^sp.edu.*pr", "\\hspace{.5em}head spouse primary",
  "^sp.edu.*sec", "\\hspace{.5em}head spouse secondary",
  "^sp.sex", "\\hspace{.5em}spouse sex (female = 1)",
  "^hd.sex", "\\hspace{.5em}head sex (female = 1)",
  "^Hd.edu.*pr", "head primary",
  "^Hd.edu.*sec", "head secondary",
  "^Sp.age", "spouse age",
  "^Sp.edu.*pr", "head spouse primary",
  "^Sp.edu.*sec", "head spouse secondary",
  ...
  "^nonmuslim.yr.$|^nonmuslim$", "\\hspace{.5em}Non-Muslim",
...
# weather variables
  "^flooded.yr2$|^flooded$", "\\hspace{.5em}Flood",
